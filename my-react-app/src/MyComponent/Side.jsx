      ...
      <h1 className='font-bold text-2xl mt-4 md:block hidden '> {name} </h1>
        ...
        <nav className="flex flex-col flex-grow overflow-y-auto mt-20">
          <ul className="flex flex-col">
            <li className="py-1 m-2 md:block hidden text-black font-bold hover:text-slate-600 hover:bg-gray-400 text-center"> <div className='flex text-center ml-14'> <img className='h-8 mr-2 ' src={dashboard} alt="Dashboard" /><a className='text-black hover:text-slate-600' href='a.html'>Dashboard</a></div></li>
